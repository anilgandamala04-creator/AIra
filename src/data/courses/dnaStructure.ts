...
export const dnaStructureSteps: TeachingStep[] = [
    ...
    // ========================================
    {
        ...
        visualType: '3d-model',
        visualPrompt: '3D model of DNA double helix in a cellular environment',
        durationSeconds: 180,
        completed: false,
        complexity: 'basic',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Historical Photo 51 X-ray crystallography diffraction pattern',
        durationSeconds: 200,
        completed: false,
        complexity: 'basic',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Diagram of cell nucleus and mitochondria containing DNA strands',
        durationSeconds: 180,
        completed: false,
        complexity: 'basic',
        estimatedMinutes: 3,
    ...
    // ========================================
    {
        ...
        visualType: '3d-model',
        visualPrompt: 'Detailed 3D model of antiparallel DNA strands showing 5\' and 3\' ends',
        durationSeconds: 240,
        completed: false,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Chemical structures of Adenine, Thymine, Guanine, and Cytosine',
        durationSeconds: 240,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 4,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Hydrogen bonding visualization between complementary A-T and G-C base pairs',
        durationSeconds: 240,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 4,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Detailed view of the sugar-phosphate backbone and phosphodiester bonds',
        durationSeconds: 200,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    // ========================================
    {
        ...
        visualPrompt: 'Semi-conservative replication fork animation showing helicase and DNA polymerase',
        durationSeconds: 300,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 5,
    ...
    },
    {
        ...
        visualType: 'animation',
        visualPrompt: 'Transcription animation showing RNA polymerase moving along the DNA template',
        durationSeconds: 280,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 5,
    ...
    },
    {
        ...
        visualType: 'animation',
        visualPrompt: 'Ribosome translation animation showing tRNA bringing amino acids to mRNA',
        durationSeconds: 280,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 5,
    ...
    // ========================================
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Infographic of mutation types: point, insertion, and deletion',
        durationSeconds: 240,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 4,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'CRISPR-Cas9 mechanism diagram showing guide RNA and DNA cleavage',
        durationSeconds: 240,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 4,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Forensic DNA gel electrophoresis matching and ancestry chart examples',
        durationSeconds: 220,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 4,
    ...
    // ========================================
    {
        ...
        visualType: 'text',
        visualPrompt: 'Consolidated summary of DNA structure and key biological processes',
        durationSeconds: 180,
        completed: false,
        complexity: 'basic',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: 'quiz',
        visualPrompt: 'Interactive quiz on molecular biology and DNA technology',
        durationSeconds: 300,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 5,
