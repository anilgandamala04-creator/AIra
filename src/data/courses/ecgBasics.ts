...
export const ecgBasicsSteps: TeachingStep[] = [
    ...
    // ========================================
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Willem Einthoven and the early electrocardiograph machine',
        durationSeconds: 180,
        completed: false,
        complexity: 'basic',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Animation of electrical signal through SA node, AV node, and Bundle branches',
        durationSeconds: 220,
        completed: false,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Einthoven\'s triangle and precordial lead placement diagram',
        durationSeconds: 200,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    // ========================================
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Standard ECG grid paper with time and voltage markings',
        durationSeconds: 180,
        completed: false,
        complexity: 'basic',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Zoomed view of a normal P wave on a grid showing specific intervals',
        durationSeconds: 200,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Highlight of the PR interval on a sample ECG strip',
        durationSeconds: 200,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Breakdown of Q, R, and S waves in a standard complex',
        durationSeconds: 220,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 4,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Visualization of ventricular repolarization on an ECG with QT segment',
        durationSeconds: 200,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    // ========================================
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'The 300 rule and 1500 rule demonstrated on rhythm strips',
        durationSeconds: 200,
        completed: false,
        complexity: 'basic',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Standard 12-lead strip showing Normal Sinus Rhythm highlights',
        durationSeconds: 180,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Comparison of NSR vs Atrial Fibrillation with irregularly irregular R-R intervals',
        durationSeconds: 220,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 4,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Dangerous rhythms comparison: Ventricular Tachycardia vs Ventricular Fibrillation',
        durationSeconds: 220,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 4,
    ...
    // ========================================
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'ST elevation pattern recognition (Tombstoning) in a STEMI patient',
        durationSeconds: 240,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 4,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Diagram of Rabbit Ears (RBBB) vs broad notched R waves (LBBB) patterns',
        durationSeconds: 220,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 4,
    ...
    },
    {
        ...
        visualType: 'text',
        visualPrompt: 'Checklist infographic for systematic ECG interpretation',
        durationSeconds: 200,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    // ========================================
    {
        ...
        visualType: 'text',
        visualPrompt: 'Review map of ECG waveforms and clinical significance labels',
        durationSeconds: 180,
        completed: false,
        complexity: 'basic',
        estimatedMinutes: 3,
    },
    {
        ...
        visualType: 'quiz',
        visualPrompt: 'Interactive ECG rhythm identification and interpretation assessment',
        durationSeconds: 300,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 5,
