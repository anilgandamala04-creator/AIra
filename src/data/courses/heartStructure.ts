...
export const heartStructureSteps: TeachingStep[] = [
    ...
    // ========================================
    {
        ...
        visualType: '3d-model',
        visualPrompt: 'Realistic 3D model of the human heart showing size and position relative to the chest',
        durationSeconds: 180,
        completed: false,
        complexity: 'basic',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: '3d-model',
        visualPrompt: 'Anatomical placement of the heart in the mediastinum between lungs',
        durationSeconds: 160,
        completed: false,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Cross-section of the pericardium layers: fibrous and serous',
        durationSeconds: 180,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    // ========================================
    {
        ...
        visualType: '3d-model',
        visualPrompt: 'Cutaway view of the four heart chambers and their connections',
        durationSeconds: 200,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: '3d-model',
        visualPrompt: 'Detailed view of the right atrium interior including SA node and SVC/IVC entries',
        durationSeconds: 200,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: '3d-model',
        visualPrompt: 'Internal view of the right ventricle showing papillary muscles and moderator band',
        durationSeconds: 180,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: '3d-model',
        visualPrompt: 'Comparison of muscular thickness between left and right ventricles',
        durationSeconds: 200,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    // ========================================
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Schematic map of the four valves and blood flow direction',
        durationSeconds: 200,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: '3d-model',
        visualPrompt: 'Detailed structure of the mitral and tricuspid valves with chordae tendineae',
        durationSeconds: 180,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: '3d-model',
        visualPrompt: 'Top-down view of semilunar valves opening and closing',
        durationSeconds: 180,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 3,
    ...
    // ========================================
    {
        ...
        visualType: '3d-model',
        visualPrompt: 'The Aorta and Vena Cava relative to the heart chambers',
        durationSeconds: 180,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualType: 'diagram',
        visualPrompt: 'Surface mapping of the coronaries specifying LAD and RCA',
        durationSeconds: 200,
        completed: false,
        complexity: 'advanced',
        estimatedMinutes: 3,
    ...
    },
    {
        ...
        visualPrompt: 'Synchronized heartbeat animation showing atrial and ventricular phases',
        durationSeconds: 220,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 4,
    ...
    // ========================================
    {
        ...
        visualType: 'text',
        visualPrompt: 'Summary infographic of heart anatomy and key functions',
        durationSeconds: 160,
        completed: false,
        complexity: 'basic',
        estimatedMinutes: 3,
    },
    {
        ...
        visualType: 'quiz',
        visualPrompt: 'Cardiac anatomy recognition and flow sequence quiz',
        durationSeconds: 240,
        completed: false,
        complexity: 'intermediate',
        estimatedMinutes: 4,
