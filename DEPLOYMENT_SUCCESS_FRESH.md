...
- ✅ **JavaScript Chunks**: 15 files
  ...
  - SettingsPage: 18.75 kB
  - index: 63.34 kB
  - ui-vendor: 143.74 kB
  - react-vendor: 163.49 kB
  - TeachingPage: 266.75 kB (main bundle)
...
- **Total CSS**: 49.57 kB (9.15 kB gzipped)
- **Main Bundle (TeachingPage)**: 266.75 kB (69.93 kB gzipped)
